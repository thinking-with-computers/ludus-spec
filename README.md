...
How do you get values out of hashmaps or strcuts? The keys are keywords. There are two syntactical options, _functional keywords_ and _keyword accessors_:
